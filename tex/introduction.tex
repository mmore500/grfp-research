...
This technique employs repeated evaluation, selection, and recombination of a population of candidate architectures to evolve architectures that can be trained effectively.%TODOS
